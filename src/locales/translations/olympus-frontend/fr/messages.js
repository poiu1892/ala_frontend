/*eslint-disable*/ module.exports = {
  messages: {
    ...
    "ADD TOKEN TO WALLET": "AJOUTER UN TOKEN AU PORTEFEUILLE",
    APR: "APR",
    APY: "APY",
    "APY over time": "Evolution de l'APY",
    Amount: "Quantité",
    Approve: "Approuver",
    Asset: "Actif",
    "Award Balance will grow at 1st rebase.": "La taille de la récompense augmentera au 1er rebasement",
    "Award period has finished, click 'Start Award' to begin distribution":
      "La période de récompense est écoulée, cliquez sur 'Récompenser' pour démarrer la distribution",
    ...
    "Bond discounts": "Rabais sur les obligations",
    "Bond {0}": ["Bond ", ["0"]],
    "Buy on {0}": ["Acheter sur ", ["0"]],
    "Change Theme": "Changer le thème",
    "Change language": "Changer de langue",
    "Change locale": "Changer de langue",
    "Check back soon!": "Rendez nous une autre visite plus tard!",
    "Choose recipient address. By default, this is your currently connected address":
      "Choisissez l'addresse de reception. Par défaut il s'agit de l'addresse du portefeuille avec lequel vous êtes actuellement connecté",
    "Circulating Supply (total)": "Jetons en circulation (total)",
    Claim: "Retirer",
    "Claim all": "Tout retirer",
    "Claim all and Stake": "Tout retirer et dépôser",
    "Claim and Autostake": "Retirer et mettre en dépôt",
    "Claim and Stake": "Retirer et mettre en dépôt",
    Claimable: "Disponible",
    "Claimable Rewards": "Récompenses disponibles",
    ...
    "Deposits can be made once the prize has been awarded.":
      "Vous pourrez effectuer des dépôts quand les récompenses auront été distribuées.",
    Disconnect: "Déconnexion",
    Docs: "Documentation",
    "Early Exit Fee": "Frais de sortie prématurée",
    "Early withdraw will incur a fairness fee of {exitFee}.": [
      "Un retrait prématurée provoquera des frais de s'élevant à ",
      ["exitFee"],
      ". ",
    ],
    "Enter an amount": "Entrez un montant",
    "Exit Fee Decay Time": "Temps d'érosion des frais de sortie",
    "Farm Pool": "Fermes",
    ...
    "Please enter a valid value!": "Merci d'entrer une valeur valide!",
    "Please enter a value!": "Merci d'entrer une valeur!",
    "Pool Award Balance is currently 0.": "Le montant de la cagnote est actuellement 0.",
    "Pool owner": "Propriétaire de la cagnote",
    Price: "Prix",
    ...
    "Read more about Fairness": "A propos de l'équité",
    Recipient: "Récipiendaire",
    "Recipient Address": "Adresse de retrait",
    Redeem: "Retirer",
    "Risk Free Value of Treasury Assets": "Valeur assurée des actifs en trésorerie",
    "Runway Available": "Durée d'inflation soutenable",
    ...
    "This Prize Pool is unable to accept deposits at this time.":
      "Cette cagnote ne peut accepter de dépôts en ce moment.",
    "This Prize Pool is unable to accept withdrawals at this time.":
      "Cette cagnote ne peut accepter de retraits en ce moment.",
    "Time until fully vested": "Durée avant disponibilité totale",
    "Total Deposits": "Montant total des dépôts",
    "Total Sponsorship": "Montant total des parrainages",
    "Total Value Deposited": "Montant total déposé",
    "Total Value Locked": "Valeur totale en dépôt",
    "Transaction may revert if price changes by more than slippage %":
      "La transaction peut-être annulée si un changement de prix supérieure au pourcentage de glissement survient",
    ...
    "Your Pooled Balance (withdrawable)": "Vos avoirs dans la cagnote (Récupérable)",
    "Your Staked Balance": "Votre solde en dépôt",
    "Your Staked Balance (Depositable)": "Vos avoirs en dépôt (pouvant être mis dans la cagnote)",
    "Your odds": "Vos chances",
    "Your pool deposits": "Vos dépôts",
    "Your total awards": "Votre total de récompenses",
    "Your wallet balance": "Vos avoirs en portefeuille",
    day: "jours",
    do_bond: "Acheter",
    do_stake: "Déposer",
