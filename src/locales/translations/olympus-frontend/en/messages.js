/*eslint-disable*/ module.exports = {
  messages: {
    ...
    "Award period has finished, you can navigate to Pool Together's UI to complete distribution":
      "Award period has finished, you can navigate to Pool Together's UI to complete distribution",
    "Backing per OHM": "Backing per OHM",
    Balance: "Balance",
    Bond: "Bond",
    ...
    "Depositing {quantity} sOHM will increase odds of winning to 1 in {newOdds}": [
      "Depositing ",
      ["quantity"],
      " sOHM will increase odds of winning to 1 in ",
      ["newOdds"],
    ],
    ...
    "Withdraw sOHM": "Withdraw sOHM",
    "Withdraw sOHMt": "Withdraw sOHMt",
    ...
    "Withdrawing {quantity} sOHM reduces your odds of winning to 1 in {newOdds}": [
      "Withdrawing ",
      ["quantity"],
      " sOHM reduces your odds of winning to 1 in ",
      ["newOdds"],
    ],
    ...
    "You can choose to withdraw the deposited fund at any time. By withdrawing the fund, you are eliminating reducing the chance to win the prize in this pool in future prize periods":
      "You can choose to withdraw the deposited fund at any time. By withdrawing the fund, you are eliminating reducing the chance to win the prize in this pool in future prize periods",
    "You cannot stake more than your OHM balance.": "You cannot stake more than your OHM balance.",
    "You cannot unstake more than your sOHM balance.": "You cannot unstake more than your sOHM balance.",
    ...
    hrs: "hrs",
    min: "min",
    "sOHM Pool Details": "sOHM Pool Details",
    "sOHM Prize Pool": "sOHM Prize Pool",
    sec: "sec",
