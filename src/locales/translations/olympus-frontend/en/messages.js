/*eslint-disable*/ module.exports = {
  messages: {
    ...
    APR: "APR",
    APY: "APY",
    "APY over time": "APY over time",
    Amount: "Amount",
    Approve: "Approve",
    Asset: "Asset",
    "Award Balance will grow at 1st rebase.": "Award Balance will grow at 1st rebase.",
    ...
    "Award period has finished, you can navigate to Pool Together's UI to complete distribution":
      "Award period has finished, you can navigate to Pool Together's UI to complete distribution",
    "Backing per APE": "Backing per APE",
    Balance: "Balance",
    Bond: "Bond",
    "Bond Price": "Bond Price",
    "Bond discounts": "Bond discounts",
    "Bond {0}": ["Bond ", ["0"]],
    "Buy on": "Buy on",
    ...
    "Choose recipient address. By default, this is your currently connected address":
      "Choose recipient address. By default, this is your currently connected address",
    "Circulating Supply (total)": "Circulating Supply (total)",
    Claim: "Claim",
    "Claim all": "Claim all",
    "Claim all and Stake": "Claim all and Stake",
    "Claim and Autostake": "Claim and Autostake",
    "Claim and Stake": "Claim and Stake",
    Claimable: "Claimable",
    ...
    "Connect your wallet to stake APE": "Connect your wallet to stake APE",
    "Current Index": "Current Index",
    "Current Prize": "Current Prize",
    Dashboard: "Dashboard",
    "Debt Ratio": "Debt Ratio",
    Deposit: "Deposit",
    "Deposit sAPE": "Deposit sAPE",
    ...
    "Depositing {quantity} sAPE will increase odds of winning to 1 in {newOdds}": [
      "Depositing ",
      ["quantity"],
      " sAPE will increase odds of winning to 1 in ",
      ["newOdds"],
    ],
    "Deposits can be made once the prize has been awarded.": "Deposits can be made once the prize has been awarded.",
    Disconnect: "Disconnect",
    Docs: "Docs",
    "Early Exit Fee": "Early Exit Fee",
    "Early withdraw will incur a fairness fee of {exitFee}.": [
      "Early withdraw will incur a fairness fee of ",
      ["exitFee"],
      ".",
    ],
    "Enter an amount": "Enter an amount",
    "Exit Fee Decay Time": "Exit Fee Decay Time",
    "Farm Pool": "Farm Pool",
    Feedback: "Feedback",
    ...
    "Market Value of Treasury Assets": "Market Value of Treasury Assets",
    Max: "Max",
    "Max You Can Buy": "Max You Can Buy",
    "Migrate sAPE!": "Migrate sAPE!",
    "Next Reward Amount": "Next Reward Amount",
    ...
    "Pool Award Balance is currently 0.": "Pool Award Balance is currently 0.",
    "Pool owner": "Pool owner",
    Price: "Price",
    "Prize Pool Info": "Prize Pool Info",
    "Prize is being awarded": "Prize is being awarded",
    "Protocol Owned Liquidity APE-DAI": "Protocol Owned Liquidity APE-DAI",
    Purchased: "Purchased",
    ROI: "ROI",
    "ROI (5-Day Rate)": "ROI (5-Day Rate)",
    "Read more about Fairness": "Read more about Fairness",
    Recipient: "Recipient",
    ...
    "Staking APE": "Staking APE",
    "Start Award": "Start Award",
    "Supply (circulating/total)": "Supply (circulating/total)",
    TVD: "TVD",
    ...
    "This Prize Pool is unable to accept withdrawals at this time.":
      "This Prize Pool is unable to accept withdrawals at this time.",
    "Time until fully vested": "Time until fully vested",
    ...
    "Unstaking sAPE": "Unstaking sAPE",
    "Unwrapping sAPE": "Unwrapping sAPE",
    "Vesting Term": "Vesting Term",
    "View Contract": "View Contract",
    "Winners / prize period": "Winners / prize period",
    Withdraw: "Withdraw",
    "Withdraw Early & pay": "Withdraw Early & pay",
    "Withdraw Early & pay t": "Withdraw Early & pay t",
    "Withdraw sAPE": "Withdraw sAPE",
    "Withdraw sAPEt": "Withdraw sAPEt",
    ...
    "Withdrawing {quantity} sAPE reduces your odds of winning to 1 in {newOdds}": [
      "Withdrawing ",
      ["quantity"],
      " sAPE reduces your odds of winning to 1 in ",
      ["newOdds"],
    ],
    ...
    "You can choose to withdraw the deposited fund at any time. By withdrawing the fund, you are eliminating reducing the chance to win the prize in this pool in future prize periods":
      "You can choose to withdraw the deposited fund at any time. By withdrawing the fund, you are eliminating reducing the chance to win the prize in this pool in future prize periods",
    "You cannot stake more than your APE balance.": "You cannot stake more than your APE balance.",
    "You cannot unstake more than your sAPE balance.": "You cannot unstake more than your sAPE balance.",
    "You cannot withdraw more than your pool balance": "You cannot withdraw more than your pool balance",
    "You have an existing bond. Bonding will reset your vesting period and forfeit rewards. We recommend claiming rewards first or using a fresh wallet. Do you still want to proceed?":
      "You have an existing bond. Bonding will reset your vesting period and forfeit rewards. We recommend claiming rewards first or using a fresh wallet. Do you still want to proceed?",
    "Your Balance": "Your Balance",
    "Your Pooled Balance (withdrawable)": "Your Pooled Balance (withdrawable)",
    "Your Staked Balance": "Your Staked Balance",
    "Your Staked Balance (Depositable)": "Your Staked Balance (Depositable)",
    "Your odds": "Your odds",
    "Your pool deposits": "Your pool deposits",
    "Your total awards": "Your total awards",
    ...
    hrs: "hrs",
    min: "min",
    "sAPE Pool Details": "sAPE Pool Details",
    "sAPE Prize Pool": "sAPE Prize Pool",
    sec: "sec",
    "to next rebase": "to next rebase",
  },
};
