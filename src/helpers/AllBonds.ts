...
export const dai = new StableBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      bondAddress: "0xea1c49CA6C91017d55431c61330E8A0Ffe39c364",
      reserveAddress: "0x5fF640e30D755f024a7DE8f12ed74C1C02d31694",
    },
  },
});
...
export const ohm_dai = new LPBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      bondAddress: "0xC99d3ab15d558aDF32695879048F13C7F7B73b9d",
      reserveAddress: "0x86e0D7323FCD3B377fCF9a99787D5A6973B865Dd",
    },
  },
  lpUrl:
...
export const ohm_lusd = new LPBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (appleseed-lusd): using APE-DAI rinkeby contracts
...
export const ohm_weth = new CustomBond({
  ...
  networkAddrs: {
    ...
    [NetworkID.Testnet]: {
      // NOTE (unbanksy): using APE-DAI rinkeby contracts
      bondAddress: "0xcF449dA417cC36009a1C6FbA78918c31594B9377",
      reserveAddress: "0x8D5a22Fb6A1840da602E56D1a260E56770e0bCE2",
    },
  },
  ...
  customTreasuryBalanceFunc: async function (this: CustomBond, networkID, provider) {
    if (networkID === NetworkID.Mainnet) {
      ...
      // NOTE (appleseed): using APE-DAI on rinkeby
      const token = this.getContractForReserve(networkID, provider);
      const tokenAddress = this.getAddressForReserve(networkID);
      const bondCalculator = getBondCalculator(networkID, provider);
      const tokenAmount = await token.balanceOf(addresses[networkID].TREASURY_ADDRESS);
